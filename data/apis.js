...
window.WOWF_APIS = [
  ...
  },
  {
    ...
    limit:
      'It reports the build, never the contents: a version bump says a client changed, not what changed. It also carries no date, so a build number is only ever reported alongside the date it was observed. A product code that does not exist must not be inferred — the Forever code returned no data on this path and is recorded as unidentified (C193).'
  },
  {
    id: 'bnet-version-era',
    ...
    verified: '2026-09-19',
    observed:
      'HTTP 200 with no credentials, returning 1.15.9.69722 for every region on 19 September 2026 (BuildId 69722). Used here as the control that proves the path shape works, because the same request against a Forever product code returned no data instead.',
